...
## Українська
## Сертифікат
Я завершила офіційний курс Vercel:
**Next.js App Router Fundamentals**  
Видано: Vercel  
Дата: 22 липня 2026
[Переглянути сертифікат](https://nextjs.org/learn/certificate?course=dashboard-app&user=167116&certId=dashboard-app-167116-1784754820091)
...
- Потокове завантаження інтерфейсу зі станами завантаження на рівні маршруту, багаторазовими skeleton-компонентами та `Suspense` boundaries на рівні компонентів.
